...
```text
# 目的・概要
私は小売店の店舗マネージャーです。コンピューターの操作にあまり慣れていませんが、Microsoft 365 Copilot Chatを初めて利用します。それぞれの業務内容に合わせたタスク一覧を作り、それぞれに最適なプロンプトを作成してください。また、そのプロンプトをもとに自分で順を追って作業できる、分かりやすく具体的なチュートリアルも作ってください。
