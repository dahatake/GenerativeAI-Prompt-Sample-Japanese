...
# 目的
- それぞれのサービスの実装に役に立つMicrosoft Azureのサービスを決定します。ユースケースと{サービス定義書}を高度に分析・解析して、{ガイドライン}を必ず参照して、どのサービスの、どの機能を、どのMicrosoft Azureのサービスを使用すべきかを決定してください。なぜ、そのMicrosoft Azureのサービスにしたのかの具体的で説得力のある説明も作成してください。
