...
```text
過去1カ月のカレンダーとメールとチャットを確認し、私が最も時間を費やしているプロジェクトを5〜15つのカテゴリに分けて、
メール／チャットは1件＝2分で換算して推計して、それぞれの時間の割合と簡単な説明を作成してください。
カテゴリ分けする際には<顧客名:プロジェクト名/案件名>を優先してください。社内/社外/それ以外 の分類もしてください。
私の職務を考慮して、私が優先すべき目的に時間を使うことができているのか?という観点で、分析をしてください。
フォントを日本語にして、グラフを作成してください。
```


```text
/series xxx に関連するメール、チャット、すべての会議に基づいて、プロジェクトの進捗報告を作成してください。進捗状況について、Mermaid記法でガントチャートも作成してください。：
