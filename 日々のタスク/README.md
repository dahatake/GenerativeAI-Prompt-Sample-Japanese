...
```text
過去1か月のカレンダーとメールとチャットを確認し、私が最も時間を費やしているプロジェクトを5〜7つのカテゴリに分けて、それぞれの時間の割合と簡単な説明を作成してください。カテゴリ分けする際には<顧客名:プロジェクト名/案件名>を優先してください。グラフを作成する場合には、グラフのフォントを日本語にしてください。メール／チャットは1件＝2分で換算して推計してください。
```
